...
def convert_label(path, lb_path, image_id):
    ...
    for class_name in classes:
        if (class_name == classes[1] and len(image_id) == 4):
            continue
        ...
        names = list(['insulator', 'defect'])  # names list
...
insulatorDataSet2YOLO(Source_root, Target_root, is_test=False, shuffle=True, train_ratio=0.7)